...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('imagenes/cerveza%20(1).png')}}" />
...
<body>
    ...
    <main class="principal">
        ...
        <section class="page" id="bienvenidos">
            ...
            <p>Un bello parque que constituye junto con el cercano Parque Almirante Lahule el pulmón verde del centro de
                nuestra ciudad Justo aquí en este idílico ambiente le ofrecemos nuestros servicios de restauración y
                cafetería, con nosotros podrá celebrar desde el cumpleaños de sus hijos su primera comunión , comida de
                empresa o cualquier otra celebración.</p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body mx-auto">
                    <img id="cumples" class="img-fluid" src="imagenes/volante-a5-cumpleaos-final-2.jpg"
                        alt="menu de cumpleaños a 5€">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body mx-auto">
                    ...
                    <img id="meriendas" class="img-fluid" src="imagenes/merienda.gif"
                        alt="distintas opciones para celebrar una merienda en El Barrero">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body mx-auto">
                    ...
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1907.9424978951388!2d-6.204453051027937!3d36.463258906843244!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x8cf932b91ce71ac0!2sBar+Barbacoa+Barrero!5e0!3m2!1ses!2ses!4v1562588390158!5m2!1ses!2ses"
